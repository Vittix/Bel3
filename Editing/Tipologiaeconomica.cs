...
namespace Bel3
{
    public partial class Tipologiaeconomica : Form
    {
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            if (mConnection != null)
            {
                ...
                mConnection.cmdMySQL.CommandText = "INSERT INTO tipologiaeconomica (nome) VALUES('" + roomName.Text + "')";
        ...
        private void Modify_Click(object sender, EventArgs e)
        {
            if (mConnection != null)
            {
                ...
                mConnection.cmdMySQL.CommandText = "UPDATE tipologiaeconomica SET nome = '" + roomName.Text + "' WHERE operatori.nome = '" + ListaStanze.SelectedItem.ToString() + "'";
                mConnection.cmdMySQL.ExecuteNonQuery();
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            if (mConnection != null)
            {
                ...
                {
                    mConnection.cmdMySQL.CommandText = "DELETE FROM tipologiaeconomica WHERE nome = '" + ListaStanze.SelectedItem.ToString() + "'";
                    mConnection.cmdMySQL.ExecuteNonQuery();
                }
                else
                {
                    ...
                    {
                        mConnection.cmdMySQL.CommandText = "DELETE FROM tipologiaeconomica WHERE nome = '" + ListaStanze.SelectedItems[i].ToString() + "'";
                        mConnection.cmdMySQL.ExecuteNonQuery();
                    }
                }
                mConnection.cnMySQL.Close();
